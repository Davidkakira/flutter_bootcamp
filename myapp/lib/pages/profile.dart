              ...
              child: Column(
                children: [
                  Container(
                    ...
                    child: Center(
                      child: Text(
                        contactslocal.first.firstName[0] +
                            contactslocal.first.lastName[0],
                        style: TextStyle(color: Colors.white, fontSize: 25),
                      ),
                    ),
                  ),
                  Text(
                    "${contactslocal.first.firstName} ${contactslocal.first.lastName}",
                    style: TextStyle(color: Colors.white, fontSize: 25),
                  ),
                  Text(
                    contactslocal.first.email,
