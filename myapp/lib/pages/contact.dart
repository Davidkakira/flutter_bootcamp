...
class _ContactState extends State<Contact> {
  ...
  Widget build(BuildContext context) {
    final favoriteContacts = contactslocal.where((contact) {
      setState(() {});
              ...
              child: ListView(
                children: [
                  ...
                  Column(
                    ...
                    spacing: 8,
                    children: [
                      Text("tout les  Contacts (${contactslocal.length})"),
                      Column(
                        children: List.generate(contactslocal.length, (index) {
                          final currentContact = contactslocal[index];
                          return ContactCardView(
                            currentContact: currentContact,
                          );
                        }),
...
class ContactCardView extends StatefulWidget {
  ...
  final ModelContact currentContact;
